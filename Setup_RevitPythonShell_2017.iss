...
Source: "RevitPythonShell\RevitPythonShell.xml"; DestDir: "{userappdata}\RevitPythonShell2017"; Flags: onlyifdoesntexist
Source: RevitPythonShell\init.py; DestDir: {userappdata}\RevitPythonShell2017; Flags: confirmoverwrite; 
Source: RevitPythonShell\startup.py; DestDir: {userappdata}\RevitPythonShell2017; Flags: confirmoverwrite; 
