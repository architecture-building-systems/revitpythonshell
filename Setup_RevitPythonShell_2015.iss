[Files]
Source: "RevitPythonShell\bin\Debug 2015\PythonConsoleControl.dll"; DestDir: "{app}"; Flags: replacesameversion
Source: "RevitPythonShell\bin\Debug 2015\RevitPythonShell.dll"; DestDir: "{app}"; Flags: replacesameversion
Source: "RevitPythonShell\bin\Debug 2015\RpsRuntime.dll"; DestDir: "{app}"; Flags: replacesameversion
...
Source: "RevitPythonShell\DefaultConfig\RevitPythonShell.xml"; DestDir: "{userappdata}\RevitPythonShell2015"; Flags: onlyifdoesntexist
Source: RevitPythonShell\DefaultConfig\init.py; DestDir: {userappdata}\RevitPythonShell2015; Flags: confirmoverwrite; 
Source: RevitPythonShell\DefaultConfig\startup.py; DestDir: {userappdata}\RevitPythonShell2015; Flags: confirmoverwrite; 
