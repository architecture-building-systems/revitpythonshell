...
Source: RevitPythonShell\init.py; DestDir: {userappdata}\RevitPythonShell2015; Flags: confirmoverwrite; 
Source: RevitPythonShell\startup.py; DestDir: {userappdata}\RevitPythonShell2015; Flags: confirmoverwrite; 
