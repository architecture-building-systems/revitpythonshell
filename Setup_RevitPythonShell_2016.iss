...
Source: RevitPythonShell\init.py; DestDir: {userappdata}\RevitPythonShell2016; Flags: confirmoverwrite; 
Source: RevitPythonShell\startup.py; DestDir: {userappdata}\RevitPythonShell2016; Flags: confirmoverwrite; 
