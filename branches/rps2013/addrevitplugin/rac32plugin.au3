...
; addrevitplugin
; 
; adds a plugin to Autodesk Revit Architecture 2010 32 bit by altering the Revit.ini 
; file.
; =============================================================================

#include "librevitplugin.au3"

; Revit Architecture 2010 32 bit - see: http://thebuildingcoder.typepad.com/blog/2009/02/revit-install-path-and-product-guids.html
